...
<option value="gchild">G.Children</option>
	...
	<tr><td><h2 style="font-family:Agency FB;font-size:2vw;color:white">Enter Password: </h2></td><td><input style="color:black;width:220px;height:20px" type="password" name="pass" required></td>
	
	<tr><td></td><td><input type="submit" value="login" style="width:220px;height:30px;color:black;background-color:white;"></td></tr>
	</table>
	</center>
</form>
</body>
